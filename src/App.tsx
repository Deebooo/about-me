...
const skills = [
  ...
  },
  {
    ...
    sections: [
      {
        title: "Techniques",
        items: ["Image Segmentation", "Image Generation", "Object Detection"],
      },
      {
        title: "Tools",
        items: [
...
const engieProjects = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "Evaluation pipeline measuring retrieval F1-score, BLEU, ROUGE, and exact match accuracy using MLflow and Ragas",
  ...
  },
  {
    ...
    overview:
      "Implementation of a Machine Learning system to detect anomalies in energy production data. This system identifies irregularities in real time, reducing waste and inefficiencies while optimizing energy performance and promoting sustainability.",
    keyPoints: [
      "Implementation of real-time anomaly detection in temporal energy data to identify irregularities",
      "Reduction of operational inefficiencies and waste by 7% through predictive analytics",
    ],
    techStack: "Python, AWS, Meta Prophet, scikit-learn, statsmodels, MLflow",
  },
  {
    title: "Deployment & Monitoring of Inventory Forecasting Models for HVAC and Water Treatment Equipment",
    overview:
      "Implementing MLOps practices to automate the deployment and monitor Time Series models for stock forecasting, thereby improving inventory management, optimizing stock levels, ensuring product availability, and reducing costs.",
    keyPoints: [
      "Evaluation of different time series forecasting models to predict stock levels with high accuracy",
      "Packaging of ML models using MLflow, including model registry, versioning, and deployment with Databricks",
      "Implementation of an end-to-end workflow: ETL, data cleansing, data processing, and fine-tuning",
      "Enablement of end users to make predictions via a Databricks dashboard",
    ],
    techStack: "Python, AWS, Prophet, statsmodels, Databricks, MLflow",
  },
];
const personalProjects = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "Evaluation pipeline measuring retrieval F1-score, BLEU, ROUGE, and exact match accuracy",
